...
parser.add_argument('--train_batch', type=int, default=500, help='Training batch size.')
parser.add_argument('--valid_batch', type=int, default=500, help='Validation batch size.')
